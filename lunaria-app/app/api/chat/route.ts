...
import { parseAssistantReply, stringifyAssistantMessage, sanitizeAssistantText } from '../../../lib/lunaria/assistant-reply'
      ...
      async start(controller) {
        ...
        try {
          if (precomputedReply !== null) {
            ...
            const structuredReply = withGameHandoffNextStep(parseAssistantReply(sanitizeAssistantText(raw)), gameHandoffNextStep)
            assistantMeta = toAssistantMeta(structuredReply)
