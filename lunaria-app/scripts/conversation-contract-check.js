...
const checks = [
  ...
  {
    // チャットUIは app/page.tsx から components/LunariaHome.tsx へ移設済み
    file: 'components/LunariaHome.tsx',
    markers: [
      ...
      { label: 'current mood group label', value: 'aria-label="Lunariaの現在の気分"' },
      { label: 'current mood live status', value: 'role="group" aria-live="polite" aria-atomic="true" aria-label="Lunariaの現在の気分"' },
      ...
      { label: 'next step accessible label', value: 'aria-label="Lunariaからの次の提案"' },
      ...
      { label: 'conversation accessible label', value: 'aria-label="Lunariaとの会話"' },
      { label: 'conversation busy state', value: 'aria-busy={loading}' },
      { label: 'empty conversation hint label', value: 'role="note" aria-label="Lunariaに話しかける"' },
      { label: 'message stable key', value: 'key={`${m.role}-${m.ts}-${i}`}' },
      { label: 'assistant message accessible label', value: "'Lunariaのメッセージ'" },
      { label: 'user message accessible label', value: "'あなたのメッセージ'" },
      { label: 'assistant message decoration hidden', value: 'ai && <div aria-hidden="true"' },
      { label: 'ticket toast live status', value: 'role="status" aria-live="polite" aria-atomic="true" aria-label="ガチャ券を受け取りました"' },
      { label: 'typing status label', value: 'aria-label="Lunariaが返信中"' },
      { label: 'typing live status', value: 'role="status" aria-live="polite" aria-atomic="true" aria-label="Lunariaが返信中"' },
      { label: 'typing decorative dots hidden', value: '<span aria-hidden="true" className="blink-dot"' },
      { label: 'message composer group', value: 'role="group" aria-label="Lunariaへのメッセージ入力"' },
      { label: 'chat input accessible label', value: 'aria-label="Lunariaへのチャットメッセージ"' },
      ...
      { label: 'send button accessible label', value: 'aria-label="Lunariaにメッセージを送る"' },
