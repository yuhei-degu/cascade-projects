...
const REASONING_LEAK_RE = /思考プロセス|【思考開始】|【思考終了】|THOUGHT|【今回のムーブ指示】|対応方針|応答の構成|試作\s*\d|回答の方針|回答案|構成案|最終チェック|最終案|最終的な返答|これで返信します|返答を作成|承知いたしました|として返答します|返答例|プラン：|話し方ルール|絶対規則|これでいく|これで良いだろう|^考え中|^PH:|^WILCO/m
const REASONING_END_MARKERS = [
  '【思考終了】',
  'これでいこう。', 'これでいく。', 'これでいく！', 'よし、これで決定。', 'これで決定。',
  '返答例：', '返答例:',
