...
|---|---:|---:|---|
| Local MVP / Private Alpha | 72% | 28% | Usable locally, core loops exist, diary/memory UI is clearer, candidate restore UI and core memory actions exist, but real DB verification remains |
...
| Chat core | 74% | 26% | Functional | Chat route and prompt foundation exist. AssistantReply parsing, optional metadata response, and chat mood handoff are wired behind text fallback. |
...
Estimated Private Alpha remaining: about 28%.
