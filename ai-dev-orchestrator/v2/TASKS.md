...
- [x] 【実利用FB】UI全体の品質を引き上げる: ランディングページで使ったダーク+ゴールドの世界観(背景#080706系、アクセント#f1c77f系)をデザイントークンとして統一し、チャットホーム・ガチャ・日記・ログインへ適用する。具体的に: メッセージバブルの形状と余白の洗練、行間と文字サイズの階層整理、ボタンの統一スタイル(hover/active込み)、モバイル幅(375px)での崩れ解消、過剰なボーダーや素のHTML感の除去。機能変更はしない
